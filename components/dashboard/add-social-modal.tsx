...
export function AddSocialModal({ profileId, position, onClose, onSuccess }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-900 p-6">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-white">Add Social Link</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-2 block text-sm text-gray-400">Profile URL</label>
            <input
              type="url"
              value={url}
